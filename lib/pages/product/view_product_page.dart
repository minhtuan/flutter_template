...
import 'package:flutter_template/pages/search/search_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: SvgPicture.asset('assets/icons/search_icon.svg', fit: BoxFit.scaleDown,),
              onPressed: () => Navigator.of(context)
                  .push<dynamic>(MaterialPageRoute<dynamic>(builder: (_) => SearchPage())),
            )
          ],
          title: Text(
            'Headphones',
