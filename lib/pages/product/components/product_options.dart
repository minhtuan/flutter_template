...
import 'package:flutter_template/pages/shop/check_out_page.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: () async {
                      Navigator.of(context).push<dynamic>(MaterialPageRoute<dynamic>(builder: (_) => CheckOutPage()));
                  ...
                  InkWell(
                    onTap: () {
                      // scaffoldKey.currentState.showBottomSheet<dynamic>((context) {
